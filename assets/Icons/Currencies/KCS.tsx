...
const KCS = (props: any) => (
  ...
  >
    ...
    <Path
      fillRule='evenodd'
      clipRule='evenodd'
      d='m13.945 16 4.022 4.1 2.552-2.553c.464-.464 1.16-.464 1.547 0a1.214 1.214 0 0 1 0 1.702l-3.326 3.403a1.122 1.122 0 0 1-1.624 0l-4.796-4.95v2.939c0 .619-.541 1.16-1.16 1.16-.619 0-1.16-.541-1.16-1.16v-9.282c0-.619.541-1.16 1.16-1.16.619 0 1.16.541 1.16 1.16v2.94l4.796-4.95a1.122 1.122 0 0 1 1.624 0l3.326 3.402a1.214 1.214 0 0 1 0 1.702c-.464.464-1.16.464-1.547 0l-2.552-2.63L13.945 16Zm4.022-1.16c.619 0 1.16.541 1.16 1.16 0 .619-.541 1.16-1.16 1.16-.619 0-1.16-.541-1.16-1.16 0-.619.541-1.16 1.16-1.16Z'
      fill='#fff'
    />
    <Defs>
      <LinearGradient
      ...
      >
        <Stop stopColor='#C859C9' />
        <Stop offset={1} stopColor='#B33BB5' />
      </LinearGradient>
    </Defs>
  </Svg>
);
