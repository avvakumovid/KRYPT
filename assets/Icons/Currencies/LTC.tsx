...
const LTC = (props: any) => (
  ...
  >
    ...
    />
    <Path
      d='m14.94 20.537 1.115-3.76 1.737-.492.363-1.244-1.71.518 1.814-6.17v-.098a.301.301 0 0 0-.311-.29H15.64a.391.391 0 0 0-.39.284L13.1 16.596l-1.711.519L11 18.307l1.711-.518-1.53 5.21h9.126a.387.387 0 0 0 .389-.284l.518-1.79v-.098a.3.3 0 0 0-.31-.29H14.94Z'
      fill='#fff'
    />
    <Defs>
      <LinearGradient
      ...
      >
        <Stop stopColor='#1EA3A3' />
        <Stop offset={1} stopColor='#1A8D8D' />
      </LinearGradient>
    </Defs>
  </Svg>
);
