...
const BUSD = (props: any) => (
  ...
  >
    ...
    <G clipPath='url(#b)' fill='#fff'>
      <Path d='M17.858 10.403 16 8.5l-4.68 4.724 1.859 1.858 4.68-4.679ZM20.679 13.224l-1.858-1.903-7.5 7.545 1.858 1.858 7.5-7.5ZM10.358 14.142l1.858 1.903-1.858 1.858L8.5 16.045l1.858-1.903ZM23.5 16.045l-1.858-1.903-7.5 7.544L16 23.545l7.5-7.5Z' />
    </G>
    <Defs>
      <LinearGradient
        id='a'
      ...
      >
        <Stop stopColor='#7878F8' />
        <Stop offset={1} stopColor='#4747F5' />
      </LinearGradient>
      <ClipPath id='b'>
