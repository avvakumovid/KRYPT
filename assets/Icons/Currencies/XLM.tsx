...
const XLM = (props: any) => (
  ...
  >
    ...
    />
    <Path
      d='M23.5 10.08v1.297l-15 7.643v-1.296l.545-.279a1.154 1.154 0 0 0 .627-1.115 6.346 6.346 0 0 1 10.056-5.62l-1.188.606a5.195 5.195 0 0 0-7.685 5.207L23.5 10.081ZM11.66 18.703l11.84-6.03v1.293l-.546.278a1.155 1.155 0 0 0-.626 1.116 6.347 6.347 0 0 1-10.056 5.62l1.12-.57.064-.034a5.196 5.196 0 0 0 7.692-5.212L8.5 21.61v-1.296l3.16-1.61Z'
      fill='#fff'
    />
    <Defs>
      <LinearGradient
      ...
      >
        <Stop stopColor='#A64ED4' />
        <Stop offset={1} stopColor='#8E2FC1' />
      </LinearGradient>
    </Defs>
  </Svg>
);
