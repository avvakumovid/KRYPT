...
const LINK = (props: any) => (
  ...
  >
    ...
    />
    <Path
      d='m16.002 8.5-1.376.791-3.75 2.168-1.376.791v7.5l1.376.791 3.785 2.168 1.376.791 1.376-.791 3.715-2.168 1.377-.791v-7.5l-1.377-.791-3.75-2.168-1.376-.791Zm-3.75 9.667v-4.334l3.75-2.168 3.75 2.168v4.334l-3.75 2.168-3.75-2.168Z'
      fill='#fff'
    />
    <Defs>
      <LinearGradient
      ...
      >
        <Stop stopColor='#1480EB' />
        <Stop offset={1} stopColor='#1066BC' />
      </LinearGradient>
    </Defs>
  </Svg>
);
