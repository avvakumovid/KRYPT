...
const USDT = (props: any) => (
  ...
  >
    ...
    <Path
      fillRule='evenodd'
      clipRule='evenodd'
      d='M17.424 16.432c-.08.006-.49.03-1.407.03-.73 0-1.247-.021-1.429-.03-2.818-.124-4.921-.614-4.921-1.202 0-.587 2.103-1.077 4.921-1.203v1.917c.185.013.712.044 1.441.044.875 0 1.314-.037 1.393-.044v-1.916c2.812.126 4.91.616 4.91 1.202s-2.098 1.077-4.91 1.201l.002.001Zm0-2.602v-1.715h3.925V9.5H10.664v2.615h3.924v1.714c-3.19.147-5.588.779-5.588 1.536s2.398 1.388 5.588 1.535v5.496h2.836v-5.498c3.182-.146 5.576-.777 5.576-1.534 0-.756-2.392-1.387-5.576-1.535v.001Z'
      fill='#fff'
    />
    <Defs>
      <LinearGradient
