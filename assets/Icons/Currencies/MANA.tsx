...
const MANA = (props: any) => (
  ...
  >
    ...
    />
    <Path
      d='M15.117 11.52a1.02 1.02 0 1 1-2.039 0 1.02 1.02 0 0 1 2.04 0ZM19.26 15.802a2.04 2.04 0 1 0 0-4.079 2.04 2.04 0 0 0 0 4.079ZM9 19.88l5.098-6.118 3.94 4.73 1.222-1.467v4.486h-3.735l1.358-1.631H9Z'
      fill='#fff'
    />
    <Path d='M19.26 17.025v4.486H23l-3.74-4.486Z' fill='#fff' />
    <Defs>
      <LinearGradient
        id='a'
        x1={16}
      ...
      >
        <Stop stopColor='#E3638E' />
        <Stop offset={1} stopColor='#DC386E' />
      </LinearGradient>
    </Defs>
  </Svg>
);
