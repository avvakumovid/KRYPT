...
const BNB = (props: any) => (
  ...
  >
    ...
    <G clipPath='url(#b)' fill='#fff'>
      <Path d='m16 11.89-2.913 2.913-1.695-1.695L16 8.5l4.61 4.61-1.695 1.694L16 11.89ZM10.195 14.305 8.5 16l1.695 1.695L11.89 16l-1.695-1.695ZM16 20.11l-2.913-2.913-1.697 1.693L16 23.5l4.61-4.61-1.696-1.694L16 20.11ZM21.805 14.306 20.11 16l1.695 1.695L23.5 16l-1.695-1.695Z' />
      <Path d='M17.72 15.999h-.001.002L17.72 16 16 17.72l-1.719-1.718-.002-.003.002-.002L16 14.279l1.72 1.72Z' />
    </G>
    <Defs>
      <LinearGradient
        id='a'
