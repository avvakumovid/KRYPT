...
const ALGO = (props: any) => (
  ...
  >
    ...
    <G clipPath='url(#b)'>
      <Path
        d='m11.093 23.5 2.169-3.757L15.432 16l2.155-3.757.357-.595.16.595.66 2.474-.74 1.283-2.17 3.743-2.156 3.757h2.593l2.17-3.757 1.124-1.944.529 1.944 1.005 3.757h2.328l-1.005-3.757L21.436 16l-.264-.966 1.614-2.79H20.43l-.08-.278-.82-3.07-.105-.396h-2.262l-.053.08-2.116 3.663L12.825 16l-2.156 3.743L8.5 23.5h2.593Z'
        fill='#fff'
      />
    </G>
    <Defs>
