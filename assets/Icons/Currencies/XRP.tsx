...
const XRP = (props: any) => (
  ...
  >
    ...
    />
    <Path
      d='M23.47 10h-2.167l-3.43 3.393a2.67 2.67 0 0 1-3.748 0L10.697 10h-2.17l4.514 4.467a4.216 4.216 0 0 0 5.918 0L23.471 10ZM8.5 22.422h2.17L14.127 19a2.67 2.67 0 0 1 3.747 0l3.457 3.42H23.5l-4.541-4.494a4.216 4.216 0 0 0-5.918 0L8.5 22.422Z'
      fill='#fff'
    />
    <Defs>
      <LinearGradient
