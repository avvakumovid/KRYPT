...
const VET = (props: any) => (
  ...
  >
    ...
    />
    <Path
      d='M14.948 22.522 8.533 9.455A.317.317 0 0 1 8.816 9h2.223a.32.32 0 0 1 .284.172l4.685 9.48c.418.85 1.626.85 2.044 0l4.67-9.473a.32.32 0 0 1 .283-.171h.276c.165 0 .269.171.195.313l-6.483 13.201c-.418.85-1.627.85-2.045 0Z'
      fill='#fff'
    />
    <Defs>
      <LinearGradient
